...
// HTTPS Enforcer
if (ConfigManager::GetConfiguration('website.https') === true && getRequestProtocol() == "http") {
...
if (!empty($callback)) {
    if (!is_callable($callback)) {
        $controllersPath = trim(str_replace('/', '\\', ConfigManager::GetConfiguration('website.controller')), '\\');
